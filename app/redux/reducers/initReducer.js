...
const initReducer = (state = _state.InitState, action) => {
  ...
  switch (action.type) {
    ...
    //Box
    case ACTION_CONST.GET_BOX_SUCCESS:
      return {
        ...state,
        listBox: { ...state.listBox, ...upSuccess },
      };
    //Gem
    case ACTION_CONST.GET_BOX_GEM:
      return {
        ...state,
        listGem: { ...state.listGem, ...upSuccess },
      };
    // GET_SHOES_ID
