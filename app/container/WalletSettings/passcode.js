  ...
  handle = () => {
    ...
    if (!isPass) {
      ...
      if (this.state.isConfirm) {
        if (
          this.state.inputCreatePasscode === this.state.inputConfirmPasscode
        ) {
          this.setState(
            state => {
              return {
                ...
                <ImageBackground
                  ...
                  {isPass && (
                    <TextInput
                      ...
                      value={this.state.inputPasscode}
                      placeholder={'******'}
                    />
                  )}
                  ...
                  {!isPass && !this.state.isCreate && (
                    <TextInput
                      ...
                      value={this.state.inputConfirmPasscode}
                      placeholder={'******'}
                    />
                  )}
                </ImageBackground>
            ...
            <View
              ...
              {isPass && (
                <TouchableOpacity
                  ...
                  disabled={this.state.inputPasscode === ''}>
                  {isPass && (
                    <Image
                      style={{
                        width: getSize.Width,
