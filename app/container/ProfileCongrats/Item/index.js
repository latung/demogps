    ...
    <View style={{ flex: 1, width: getSize.Width }}>
      <ImageBackground
        style={{
          ...
          zIndex: -1,
          top:
            Platform.OS === 'android' ? getSize.scale(-32) : getSize.scale(-48),
        }}
      ...
      <MapboxGL.MapView
        style={{
          ...
          zIndex: -2,
          top:
            Platform.OS === 'android' ? getSize.scale(-80) : getSize.scale(-48),
        }}>
        <MapboxGL.Camera
          zoomLevel={15}
          centerCoordinate={
      ...
      {/* Content */}
      <View
        style={{ flex: 7, justifyContent: 'flex-end', alignItems: 'center' }}>
        <ImageBackground
          style={{
            ...
            <View
              ...
              <View
                ...
                <Text
                  ...
                  {data.user.slice(0, 3)}...{data.user.slice(-3)}
                </Text>
                <Text
                  style={{
                    fontSize: getSize.scale(14),
      ...
      <View
        ...
        {/* <TouchableOpacity
          onPress={() => navigation.navigate(stackNavigator.PROFILE_SHARE)}>
          <ImageBackground
            style={{
