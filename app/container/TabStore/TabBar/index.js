      ...
      <View style={{ flex: 1, marginTop: getSize.scale(8) }}>
        ...
        <View
          style={{
            ...
            minHeight: Platform.OS === 'android' ? getSize.scale(38) : 0,
            marginTop:
              Platform.OS === 'android' ? getSize.scale(4) : getSize.scale(24),
          }}>
          {isSneakers ? (
            <View
              style={{
                    ...
                    <View
                      ...
                      <View
                        ...
                        <TouchableOpacity
                          ...
                          <View
                            style={{
                              backgroundColor: isLowestPrice && '#2EDBDC',
                              top: 4,
                              height: 5,
                        ...
                        <TouchableOpacity
                          ...
                          <View
                            style={{
                              backgroundColor: isHighestPrice && '#2EDBDC',
                              top: 4,
                              height: 5,
                        ...
                        <TouchableOpacity
                          ...
                          <View
                            style={{
                              backgroundColor: isLatestPrice && '#2EDBDC',
                              top: 4,
                              height: 5,
