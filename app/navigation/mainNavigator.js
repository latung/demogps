  ...
  render() {
    return (
      <Stack.Navigator
        ...
        {/* WALLET */}
        <Stack.Screen
          name={stackNavigator.SPENDING_WALLET}
          component={SpendingWallet}
        />
        <Stack.Screen name={stackNavigator.WALLET_NEW} component={WalletNew} />
        <Stack.Screen
          name={stackNavigator.WALLET_EXPORT}
          component={WalletExport}
        />
        <Stack.Screen
          name={stackNavigator.WALLET_IMPORT}
          component={WalletImport}
        />
        <Stack.Screen
          name={stackNavigator.WALLET_PASSCODE}
          component={WalletPasscode}
        />
        ...
        <Stack.Screen
          name={stackNavigator.PROFILE_DETAILS}
        ...
        />
        <Stack.Screen
          name={stackNavigator.PROFILE_EDIT_NAME}
          component={ProfileEditName}
        />
        <Stack.Screen
          name={stackNavigator.PROFILE_EDIT_GEND}
          component={ProfileEditGend}
        />
        <Stack.Screen
        ...
        />
        <Stack.Screen
          name={stackNavigator.PROFILE_DELETE}
        ...
        />
        <Stack.Screen
          name={stackNavigator.PROFILE_CONGRATS}
          component={ProfileCongrats}
        />
        <Stack.Screen
          name={stackNavigator.PROFILE_SHARE}
          component={ProfileShare}
        />

        <Stack.Screen
          name={stackNavigator.ROFILE_PASS_CODE}
          component={ProfilePassCode}
        />
        <Stack.Screen name={stackNavigator.TRANSFER} component={Transfer} />
        <Stack.Screen
          name={stackNavigator.WALLET_HOME}
          component={WalletHome}
        />
        <Stack.Screen
          name={stackNavigator.WALLET_COIN}
          component={WalletCoin}
        />
        <Stack.Screen
          name={stackNavigator.WALLET_SETTINGS}
        ...
        <Stack.Screen
          name={stackNavigator.RESTORE_WALLET}
          component={RestoreWallet}
        />
        <Stack.Screen
          name={stackNavigator.BACKUP_WALLET}
        ...
        <Stack.Screen
          name={stackNavigator.BACKUP_PASS_WALLET}
          component={passcodeBackup}
        />

        <Stack.Screen
          name={stackNavigator.RUN_CHECKING}
          component={RunChecking}
        />
        <Stack.Screen
          name={stackNavigator.RUN_COUNT_DOWN}
          component={RunCountdown}
        />
      </Stack.Navigator>
    );
  }
